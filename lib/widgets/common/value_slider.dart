...
class ValueSlider extends StatefulWidget {
  ...
  @override
  _ValueSliderState createState() => new _ValueSliderState();
...
class _ValueSliderState extends State<ValueSlider> with TickerProviderStateMixin {
...
class _RenderSlider extends RenderBox {
  _RenderSlider({
    ...
    this.onChangeStart,
    this.onChangeEnd,
    @required _ValueSliderState state,
  ...
  static final Tween<double> _overlayRadiusTween = new Tween<double>(begin: 0.0, end: _overlayRadius + 4.0);

  _ValueSliderState _state;
