...
/// scrollable app bar, see [SliverResponsiveAppBar], which embeds an [ResponsiveAppBar] in a sliver
/// for use in a [CustomScrollView].
///
/// The ResponsiveAppBar displays the toolbar widgets, [leading], [title], and [actions],
...
///
/// If the [leading] widget is omitted, but the [ResponsiveAppBar] is in a [Scaffold] with
...
/// See also:
///
///  * [Scaffold], which displays the [ResponsiveAppBar] in its [Scaffold.appBar] slot.
///  * [SliverResponsiveAppBar], which uses [ResponsiveAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [ResponsiveAppBar]
...
class ResponsiveAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [ResponsiveAppBar] will imply an appropriate widget. For example, if the [ResponsiveAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [ResponsiveAppBar]
  ...
  ///
  /// A flexible space isn't actually flexible unless the [ResponsiveAppBar]'s container
  /// changes the [ResponsiveAppBar]'s size. A [SliverResponsiveAppBar] in a [CustomScrollView]
  /// changes the [ResponsiveAppBar]'s height when scrolled.
  ///
  ...
  /// used by [SliverResponsiveAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
...
class _FloatingResponsiveAppBar extends StatefulWidget {
  const _FloatingResponsiveAppBar({ Key key, this.child }) : super(key: key);

  final Widget child;

  @override
  _FloatingResponsiveAppBarState createState() => _FloatingResponsiveAppBarState();
}

// A wrapper for the widget created by _SliverResponsiveAppBarDelegate that starts and
/// stops the floating appbar's snap-into-view or snap-out-of-view animation.
class _FloatingResponsiveAppBarState extends State<_FloatingResponsiveAppBar> {
...
class _SliverResponsiveAppBarDelegate extends SliverPersistentHeaderDelegate {
  _SliverResponsiveAppBarDelegate({
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    return floating ? _FloatingResponsiveAppBar(child: appBar) : appBar;
  }

  @override
  bool shouldRebuild(covariant _SliverResponsiveAppBarDelegate oldDelegate) {
...
/// the screen see [ResponsiveAppBar], which is used in the [Scaffold.appBar] slot.
///
/// The ResponsiveAppBar displays the toolbar widgets, [leading], [title], and
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverResponsiveAppBar] into its
///    scrolling.
///  * [ResponsiveAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [ResponsiveAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
///    can expand and collapse.
///  * <https://material.google.com/layout/structure.html#structure-toolbars>
class SliverResponsiveAppBar extends StatefulWidget {
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [ResponsiveAppBar] will
  /// imply an appropriate widget. For example, if the [ResponsiveAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [ResponsiveAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [ResponsiveAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [ResponsiveAppBar] is being displayed over content that is scrolled under it.
  ///
  ...
  @override
  _SliverResponsiveAppBarState createState() => _SliverResponsiveAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverResponsiveAppBarState extends State<SliverResponsiveAppBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SliverResponsiveAppBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _SliverResponsiveAppBarDelegate(
